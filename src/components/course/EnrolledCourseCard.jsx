    ...
    >
      ...
      <div className="p-5 flex flex-col h-56">
        ...
        <div className="flex items-center mb-3">
          ...
          <p className="text-gray-700 font-medium text-sm">{courseInstructor}</p>
        </div>
        
        {/* Course description */}
        {courseDescription && (
          <p className="text-gray-600 text-sm line-clamp-2 mb-3">{courseDescription}</p>
        )}
        ...
        <div className="mt-auto">
          <div className="flex justify-between text-xs font-medium mb-1.5">
            ...
            <span className={`font-semibold ${progressPercentage < 30 ? 'text-yellow-600' : progressPercentage < 70 ? 'text-blue-600' : 'text-green-600'}`}>
