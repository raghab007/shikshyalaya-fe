...
function InstructorPaymentHistory() {
    ...
    const uniquePaymentMethods = [...new Set(paymentHistory.map(payment => payment.method))];
    const uniqueStatuses = [...new Set(paymentHistory.map(payment => payment.status))];
    ...
    const filteredPayments = paymentHistory.filter(payment => {
        ...
        return matchesStartDate && matchesEndDate && matchesStatus && matchesMethod;
    }).sort((a, b) => {
        if (sortConfig.key) {
    ...
    const totalStudents = filteredPayments
        .reduce((sum, payment) => sum + payment.students, 0);
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <h2 className="text-sm font-medium text-gray-500 mb-1">Total Earnings</h2>
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 text-sm text-gray-500">
                        Showing {filteredPayments.length} out of {paymentHistory.length} payments
                    </div>
                </div>

                {/* Download Section */}
                <div className="mt-6 bg-white rounded-lg shadow-md p-6">
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">Payment Reports</h2>
